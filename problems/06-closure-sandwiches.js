...
const sandwichMaker = function() {
  let food = "One sandwich with tomato";
  return function(string) {
    return food += ' and ' + string
  }
}
...
console.log(sandwich("spinach")) // => "One sandwich with console.log(tomato and spinach"
console.log(sandwich("jelly")) // => "One sandwich with tomato console.log(and spinach and jelly"
console.log(sandwich("bread")) // => "One sandwich with tomato console.log(and spinach and jelly and bread"
let sandwich2 = sandwichMaker(); // => returns a console.log(function
